...
namespace StateEngine4net.Tests.StateEngine
{
    ...
    /// </summary>
    public class StatedTestObjectStateEngine : StatedTestObjectStateEngineBase, IStatedTestObjectStateEngine
    {
        ...
        protected override async Task<bool> StartRun(StatedTestObject statedtestobject)
        {
            /* add logic here */
            await Task.Delay(0).ConfigureAwait(false);
            return true;
        }
        protected override async Task<bool> FinalizeRun(StatedTestObject statedtestobject)
        {
            /* add logic here */
            await Task.Delay(0).ConfigureAwait(false);
            return true;
        }
        protected override async Task<bool> StartCleanup(StatedTestObject statedtestobject)
        {
            /* add logic here */
            await Task.Delay(0).ConfigureAwait(false);
            return true;
