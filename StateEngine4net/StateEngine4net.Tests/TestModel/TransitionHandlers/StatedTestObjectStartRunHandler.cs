...
namespace StateEngine4net.Tests.TestModel.TransitionHandlers
{
    ...
    /// 	for the state transition StartRun. This allows 
    ...
    public class StatedTestObjectStartRunHandler : IStatedTestObjectStartRunHandler
...
//                                              ,IAfterFailedTransition<StatedTestObject>
    {
        ...
        public StatedTestObjectStartRunHandler(/* add dependencies here */)
        {
        }
